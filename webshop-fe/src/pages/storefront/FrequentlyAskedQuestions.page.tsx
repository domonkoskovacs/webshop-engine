        ...
        <div className="max-w-4xl lg:w-1/3 p-6">
            ...
            <Accordion type="multiple" className="w-full">
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                        Click the "Sign Up" button at the top right corner of the page, fill in your details, and verify
                ...
                <AccordionItem value="item-5">
                    ...
                    <AccordionContent>
                        We offer a 30-day return policy for most products. Items must be unused and in their original
                        packaging.
                    </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-7">
                    ...
                    <AccordionContent>
                        Yes, we offer international shipping to many countries. Shipping fees and delivery times vary
                ...
                <AccordionItem value="item-8">
                    ...
                    <AccordionContent>
                        You can modify or cancel your order within the first 24 hours of placing it. Contact our support
                        team for assistance.
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-9">
                    ...
                    <AccordionContent>
                        Yes, we frequently offer discounts and promotions. Subscribe to our newsletter to stay updated
                        on our latest deals.
                    </AccordionContent>
                </AccordionItem>
