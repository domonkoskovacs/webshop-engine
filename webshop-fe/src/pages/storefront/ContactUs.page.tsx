...
const ContactUs: React.FC = () => {
    return (
        <div className="flex items-center justify-center p-6">
            <div className="w-full max-w-2xl lg:w-1/3 shadow-md rounded-lg p-8">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-lg">
                        ...
                        <a href="http://www.example.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                            www.example.com
                        </a>
                    </p>
                </div>
